...
function NotebookForm({ notebook, setShowModal }) {
  const dispatch = useDispatch();
  const [title, setTitle] = useState(notebook.title);
  const [coverUrl, setCoverUrl] = useState(notebook.coverUrl);
      ...
      <form className="notebook-form" onSubmit={handleSubmit}>
        <div className="notebook-form__card">
          ...
          <div className="notebook-form__image-container">
            <img src={coverUrl} className="notebook-form__image" alt="cover" />
          </div>
